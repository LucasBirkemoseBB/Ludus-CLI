...
namespace MsgSystem
{
  ...
  public class MessageHandler
  {
    ...
    {
      using HttpResponseMessage response = await messageClient.GetAsync("http://10.144.100.201:4201/");
    ...
    public async void sendToServer(Message message)
    {
      ...
      var post = await messageClient.PostAsync("http://10.144.100.201:4201/", content);
